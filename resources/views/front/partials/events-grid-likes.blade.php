        ...
        <div class="row">
            <div class="col-md-12">
                <div class="pre-featured">
                    <div class="info-text">
                        @if ($sorted_likes->currentPage())
                        <h4>showing {{ -2+(3*$sorted_likes->currentPage()) }}-{{ ($sorted_likes->currentPage()*3) }} of {{ $sorted_likes->total() }} courses</h4>
                        @endif
                    </div>
