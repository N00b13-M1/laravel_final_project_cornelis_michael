            ...
            <div class="fullwidthbanner">
                <ul>
                    <li class="first-slide" data-transition="fade" data-slotamount="10" data-masterspeed="300">
                        <img src="{{ asset('assets/images/slidebg-1.jpg') }}" data-fullwidthcentering="on" alt="slide">
                    ...
                    <li class="first-slide" data-transition="fade" data-slotamount="10" data-masterspeed="300">
                        <img src="{{ asset('assets/images/slidebg-2.jpg') }}" data-fullwidthcentering="on" alt="slide">
