    ...
    <div class="sidebar-menu-container" id="sidebar-menu-container">
		...
		<div class="sidebar-menu-push">
			...
			<div class="sidebar-menu-inner">
                ...
                <div class="page-heading" style="background-image: url('./assets/images/{{ $banners[4]->bg }}'); background-size: cover; background-repeat: no-repeat; width: 100%;padding: 100px 0px 0px 0px;">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
                                {{-- {{ dd($banners) }} --}}
